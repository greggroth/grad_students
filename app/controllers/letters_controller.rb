class LettersController < ApplicationController  
  ...
  def show
    ...
    if @department_chair.nil? || @graduate_advisor.nil?
      redirect_to root_path, notice: "Please ensure a graduate director and department chair have been specified and that the student's stipend has been entered."
    else
